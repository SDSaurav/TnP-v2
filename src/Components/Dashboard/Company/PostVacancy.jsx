            ...
            <Fragment>
                {this.props.currentUser ? (
                    <div className="container">
                        <br />
                        <div className="row">
                            <div className="teal darken-4 col l12 s12 darken-1 white-text center flow-text">
                                Post New Vacancy
                            </div>
                            ...
                            <form onSubmit={this.onAdd}>
                                <div className="teal col l12 s12 lighten-5">
                                    <br />
                                </div>
                                <div className="teal col l12 s12 lighten-5">
                                ...
                                <div className="col s4 l2 offset-s4 offset-l5 ">
                                    <Button cn="btn-large waves-effect waves-light teal darken-4" t="Post" />
                                </div>
                                <br />
                                <br />
                            </form>
